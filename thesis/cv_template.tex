...
\title{Luke Vinton -- CV} % Print the main header
...
{\bf Address} \> 4A23 Pevensey 2,\\ % Address line 1
\> Department of Physics and Astronomy, \\ %Address line 2
\> Brighton, BN1 9QH \\ % Address line 3
{\bf Date of Birth} \> 27$^{th}$ Novermber 1988 \\ % Date of birth 
...
\begin{tabbing} % Enables tabbing
\hspace{3cm} \= \hspace{4cm} \= \kill % Spacing within the block
{\bf Mobile Phone} \> (+44) 7857837124 \\ % Home phone
{\bf Email} \> \href{mailto:L.Vinton@sussex.ac.uk}{luke.vinton.lv@gmail.com} \\ % Email address
\end{tabbing}}
